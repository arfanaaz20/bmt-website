...
//     const errs = validateStep(currentStep, form, tab);
//     setErrors(errs);
//     if (Object.keys(errs).length === 0) alert("🎉 Property Successfully Register !\n\nBirdMyTrip team aapko jald contact karegi.");
//   };
...
//           <h1 className="lp-title">Join us to easily list and<br />manage your property</h1>
...
//         <div className="lp-logo">Trip.<span>com</span></div>
...
//           <button className="lp-save-exit">Save and exit</button>
//         </div>
//       </div>
