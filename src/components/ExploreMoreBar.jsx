...
export default function ExploreMoreBar() {
  return (
    <div className="relative -mt-2.5 flex justify-center z-5 px-2 sm:px-2">
      <div
        className="bg-white flex gap-2 sm:gap-3 
...
items-center justify-center w-fit"
      >
        ...
        <a
          href="/support"
          className="flex gap-3 sm:gap-1.5 md:gap-2 items-center cursor-pointer whitespace-nowrap flex-shrink-0 px-2 py-1.5 hover:bg-gray-50 rounded-lg transition-all"
        >
          <span className="flex items-center">
            <HeadphonesIcon
              size={20}
              className="text-[#008cff] sm:w-3 sm:h-3 md:w-4 md:h-4 lg:w-5 lg:h-5"
            />
          </span>
          <div>
            <b className="text-sm sm:text-[9px] md:text-xs lg:text-sm font-semibold">
            ...
            <p className="text-xs sm:text-[7px] md:text-[10px] lg:text-xs text-gray-500 m-0">
              We're here 24/7
            </p>
          </div>
        </a>
        ...
        >
          ...
          <div>
            <b className="text-sm sm:text-[9px] md:text-xs lg:text-sm font-semibold">
              Invite & Earn{" "}
              <span className="bg-[#e05194] text-white text-[10px] sm:text-[6px] md:text-[8px] lg:text-[10px] px-1.5 py-0.5 sm:px-1 sm:py-0 rounded-full ml-1.5 font-medium">
                new
              </span>
            </b>
            <p className="text-xs sm:text-[7px] md:text-[10px] lg:text-xs text-gray-500 m-0">
