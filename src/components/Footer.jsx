      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-2">
              <span className="px-2 py-1 bg-blue-50 text-blue-600 text-xs rounded">Trusted</span>
              <span className="px-2 py-1 bg-green-50 text-green-600 text-xs rounded">Verified</span>
            </div>
          </div>

          {/* EXPLORE */}
          <div>
            <h4 className="text-blue-600 font-semibold mb-4">Explore</h4>
          ...
          {/* SUPPORT */}
          <div>
            <h4 className="text-green-600 font-semibold mb-4">Support</h4>
            <ul className="space-y-2">
          ...
          {/* COMPANY */}
          <div>
            <h4 className="text-purple-600 font-semibold mb-4">Company</h4>
            <ul className="space-y-2">
