...
import { 
  ...
  Hotel as HotelIcon, Home
} from 'lucide-react';

const HotelAndHomeStayDetail = () => {
  const { id } = useParams();
  ...
  // Property data matching the IDs from main page
  const getPropertyData = () => {
    const properties = [
      {
        ...
        location: {
          ...
          lng: 72.8777,
          nearby: [
            "Bandra Kurla Complex - 5 min walk",
            "Mumbai Airport - 15 min drive",
            "Gateway of India - 25 min drive",
            "Marine Drive - 20 min drive"
          ]
        },
        reviewsData: {
          average: 4.8,
      ...
      },
      {
        ...
        detailedDescription: "Modern loft apartment in prime Shenzhen location. Fully equipped with all modern amenities, high-speed internet, and convenient access to public transportation.",
        images: [
          "https://images.unsplash.com/photo-1613977257363-707ba9348227?w=1200",
          "https://images.unsplash.com/photo-1616594039964-ae9021a400a0?w=600"
        ],
        amenities: [
          { id: 'wifi', name: "Free WiFi", icon: <Wifi size={20} />, description: "High-speed internet" },
          { id: 'parking', name: "Parking", icon: <Car size={20} />, description: "Available on site" },
          { id: 'gym', name: "Gym Access", icon: <Dumbbell size={20} />, description: "Building gym facility" }
        ],
        rooms: [
          {
            id: 1,
            ...
            occupancy: "3 adults",
            bed: "1 King Bed + 1 Sofa Bed",
            amenities: ["Free WiFi", "Kitchen", "Washing Machine", "TV"],
            price: 5200,
            discountPrice: 4500,
        ...
        reviewsData: {
          ...
          categories: [
            ...
            { name: "Comfort", score: 8.8 },
            { name: "Location", score: 9.4 },
            { name: "Facilities", score: 8.5 },
            { name: "Communication", score: 9.1 },
            { name: "Value", score: 9.0 }
          ],
          highlights: [
            "95% of guests recommend this property",
            "Great location mentioned in 210 reviews",
            "Modern facilities appreciated by guests"
          ]
        },
        trustBadges: [
          { icon: <Shield size={20} />, title: "Price Match Guarantee", desc: "We'll match any lower price" },
    ...
    // Find property by ID, default to first property if not found
    ...
    <div className="min-h-screen bg-slate-50 font-sans">
      ...
      <div className="sticky top-0 z-40 bg-white/95 backdrop-blur-sm border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 py-3 flex justify-between items-center">
          <div className="flex items-center gap-4">
            ...
            <span className="font-bold text-slate-700 hidden md:inline">Back to search</span>
          </div>
      ...
      <main className="max-w-7xl mx-auto px-4 py-6">
          ...
          <div className="flex flex-col md:flex-row justify-between gap-4">
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-3">
                <span className="bg-blue-600 text-white text-[10px] px-2 py-1 rounded-md uppercase font-bold tracking-wider">
                  {property.type}
                </span>
                ...
                <span className="text-xs text-slate-500 font-medium">• {property.reviews} reviews</span>
              </div>
            ...
            <div className="flex items-center gap-4">
              <div className="text-right">
                ...
                <p className="font-bold text-lg text-slate-900">{property.ratingText}</p>
                <p className="text-xs text-slate-500">{property.reviews} verified reviews</p>
              </div>
              <div className="bg-blue-600 text-white font-bold h-14 w-14 flex flex-col items-center justify-center rounded-xl">
                <span className="text-xl leading-none">{property.rating}</span>
                <div className="flex">
        ...
        <div className="grid grid-cols-4 grid-rows-2 gap-3 h-[400px] md:h-[500px] mb-8">
          ...
          >
            <img 
              src={property.images[4] || property.images[property.images.length - 1]} 
              className="w-full h-full object-cover brightness-75" 
              alt="More photos" 
            />
            <div className="absolute inset-0 flex flex-col items-center justify-center text-white">
              <span className="text-2xl font-bold">+{property.images.length - 4}</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <section className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
              ...
              <p className="text-slate-700 leading-relaxed mb-6">{property.description}</p>
              <p className="text-slate-600 leading-relaxed">{property.detailedDescription}</p>
            </section>
            ...
            <section className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-6">
                {property.reviewsData?.categories?.map((cat, idx) => (
              ...
              <div className="space-y-3">
                {property.reviewsData?.highlights?.map((highlight, idx) => (
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 space-y-6">
              ...
              <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-md">
                ...
                {selectedRoom ? (
                  <>
                    <div className="space-y-4">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="font-bold text-slate-900">
                          ₹{calculateTotal(property.rooms.find(r => r.id === selectedRoom)?.discountPrice).toLocaleString()}
                        </span>
                      </div>
                        ...
                        <div className="flex justify-between items-center">
                          ...
                          <div className="text-right">
                            <div className="text-2xl font-bold text-slate-900">
                              ₹{(calculateTotal(property.rooms.find(r => r.id === selectedRoom)?.discountPrice) + 2850 + 1200).toLocaleString()}
                            </div>
                    ...
                    <button className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 rounded-lg mt-6 transition-all flex items-center justify-center gap-2">
                      Reserve Now
              ...
              {/* Trust Badges */}
              <div className="space-y-3">
                {property.trustBadges.map((badge, idx) => (
              ...
              <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
                <h4 className="font-bold text-slate-900 mb-4">Property Policies</h4>
...
export default HotelAndHomeStayDetail;